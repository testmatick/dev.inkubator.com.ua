...
$_['text_new_greeting']         = 'Дякуємо за інтерес до товарів %s . Ваше замовлення отримане і поступить в обробку найближчим часом';

$_['text_new_received']         = 'Ви отримали замовлення.';

$_['text_new_link']             = 'Для перегляду Вашого замовлення перейдіть по посиланню:';
...
$_['text_new_download']         = 'Після підтвердження оплати, завантажувані товари будуть доступні по посиланню:';
