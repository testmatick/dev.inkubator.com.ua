...
class ControllerSaleOrder extends Controller {
	...
	public function info() {
		...
		$order_info = $this->model_sale_order->getOrder($order_id);
    					...
    					if ($data['shipping_code'] == 'novaposhta.novaposhta') {
    						$this->load->language('sale/novaposhta_ei');
				    		$data['button_create_ei'] = $this->language->get('button_create_ei');
				    		$data['novaposhta_ei'] = $this->url->link('sale/novaposhta_ei/getForm', 'token=' . $this->session->data['token'] . '&order_id=' . (int)$this->request->get['order_id'], 'SSL');
    					}
    					/* Nova Poshta express invoice*/
