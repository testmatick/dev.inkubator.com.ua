...
class ControllerExtensionModification extends Controller {
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validate()) {
            ...
            if (isset($cachecleaner)) {
				$this->response->redirect($this->url->link('cache/cleaner', 'token=' . $this->session->data['token'], 'SSL'));
			} else {
...
if (isset($this->request->get['cachecleaner'])) $cachecleaner = true;
		$this->load->language('extension/modification');
