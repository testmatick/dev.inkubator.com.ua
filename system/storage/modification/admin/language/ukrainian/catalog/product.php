...
$_['entry_date_available']   = 'Дата вступу';
...
$_['entry_subtract']         = 'Віднімати із складу';
...
$_['help_isbn']              = 'Міжнародний стандарт номера товару';
$_['help_mpn']               = 'Номер виробника';
$_['help_manufacturer']      = '(Автозаповнення)';
$_['help_minimum']           = 'Мінімальна кількість товару в замовленні (менше цієї кількості товару, додавання в кошик буде заборонено )';
$_['help_stock_status']      = 'Статус показується, коли товару немає на складі';
$_['help_points']            = 'Кількість балів для купівлі товару. Поставте 0, щоб товар не можна було придбати за бонусні бали.';
...
$_['error_permission']       = 'Ви не маєте повноважень для зміни товарів!';
