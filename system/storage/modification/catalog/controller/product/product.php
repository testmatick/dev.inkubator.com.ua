...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			$data['t1o_product_custom_content'] = $this->config->get('t1o_product_custom_content' . $this->config->get('config_language_id'));	
			$data['t1o_product_fb1_title'] = $this->config->get('t1o_product_fb1_title' . $this->config->get('config_language_id'));
			$data['t1o_product_fb1_subtitle'] = $this->config->get('t1o_product_fb1_subtitle' . $this->config->get('config_language_id'));
		    $data['t1o_product_fb2_title'] = $this->config->get('t1o_product_fb2_title' . $this->config->get('config_language_id'));
			$data['t1o_product_fb2_subtitle'] = $this->config->get('t1o_product_fb2_subtitle' . $this->config->get('config_language_id'));
		    $data['t1o_product_fb3_title'] = $this->config->get('t1o_product_fb3_title' . $this->config->get('config_language_id'));
			$data['t1o_product_fb3_subtitle'] = $this->config->get('t1o_product_fb3_subtitle' . $this->config->get('config_language_id'));
			$data['t1o_product_custom_tab_1_title'] = $this->config->get('t1o_product_custom_tab_1_title' . $this->config->get('config_language_id'));		
			$data['t1o_product_custom_tab_1_content'] = $this->config->get('t1o_product_custom_tab_1_content' . $this->config->get('config_language_id'));
			$data['t1o_product_custom_tab_2_title'] = $this->config->get('t1o_product_custom_tab_2_title' . $this->config->get('config_language_id'));		
			$data['t1o_product_custom_tab_2_content'] = $this->config->get('t1o_product_custom_tab_2_content' . $this->config->get('config_language_id'));
			$data['t1o_product_custom_tab_3_title'] = $this->config->get('t1o_product_custom_tab_3_title' . $this->config->get('config_language_id'));		
			$data['t1o_product_custom_tab_3_content'] = $this->config->get('t1o_product_custom_tab_3_content' . $this->config->get('config_language_id'));
